 ...
 */
package de.hybris.sdh.core.suggestion;
...
import de.hybris.sdh.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/sdhcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
