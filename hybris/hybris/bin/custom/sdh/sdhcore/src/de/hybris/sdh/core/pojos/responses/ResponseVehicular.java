 ...
 *
 */
public class ResponseVehicular
{
	...
	{
		return "ResponseVehicular [placa=" + placa + ", modelo=" + modelo + ", marca=" + marca + ", linea=" + linea
				+ ", anoGravable=" + anoGravable + ", pagoVoluntario=" + pagoVoluntario + ", totalPagar=" + totalPagar
