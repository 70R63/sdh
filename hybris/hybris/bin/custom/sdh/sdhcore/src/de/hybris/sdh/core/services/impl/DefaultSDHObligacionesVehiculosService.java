 ...
 *
 */
public class DefaultSDHObligacionesVehiculosService implements SDHObligacionesVehiculosService
{

	private static final Logger LOG = Logger.getLogger(DefaultSDHObligacionesVehiculosService.class);
	...
	public String obligacionesRequest(final ObligacionesRequest request)
	{
		...
		final String urlString = configurationService.getConfiguration().getString("sdh.oblivehicular.url");
		final String user = configurationService.getConfiguration().getString("sdh.oblivehicular.user");
		final String password = configurationService.getConfiguration().getString("sdh.oblivehicular.password");
