 ...
 *
 */
public class DefaultSDHUpdateCustomerCommPrefsService implements SDHUpdateCustomerCommPrefsService
{

	private static final Logger LOG = Logger.getLogger(DefaultSDHUpdateCustomerCommPrefsService.class);
	 ...
	 *
	 * @see
	 * de.hybris.sdh.core.services.SDHUpdateEmailAndComunicationPreferencesService#updateEmailAndComunicationPreferences(
	 * de.hybris.sdh.core.pojos.requests.UpdateEmailAndComunicationPreferencesRequest)
	 */
	@Override
	public String updateCustomerCommPrefs(final UpdateCustomerCommPrefsRequest request)
	{
