 ...
 *
 */
public class CalcVehiculosRequest
{
	...
	public String toString()
	{
		...
		stringBuilder.append("\"numForm\":\"" + this.getNumForm() + "\",");
		stringBuilder.append("\"anioGravable\":\"" + this.getAnioGravable() + "\",");
		stringBuilder.append("\"opcionUso\":\"" + this.getOpcionUso() + "\",");
		stringBuilder.append("\"clase\":\"" + this.getClase() + "\",");
		stringBuilder.append("\"idServicio\":\"" + this.getIdServicio() + "\",");
		stringBuilder.append("\"cilindraje\":\"" + this.getCilindraje() + "\",");
		...
		stringBuilder.append("\"clasicoAntiguo\":\"" + this.getClasicoAntiguo() + "\",");
		stringBuilder.append("\"checkAporte\":\"" + this.getCheckAporte() + "\",");
		stringBuilder.append("\"proyectoAporte\":\"" + this.getProyectoAporte() + "\",");
		...
		stringBuilder.append("\"fuenteHomologa\":\"" + this.getFuenteHomologa() + "\"");
		stringBuilder.append("}");
