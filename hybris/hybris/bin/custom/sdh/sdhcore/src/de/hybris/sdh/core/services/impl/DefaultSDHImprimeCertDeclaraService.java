...
public class DefaultSDHImprimeCertDeclaraService implements SDHImprimeCertDeclaraService
{
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.sdh.core.services.SDHImprimeCertDeclaraService#imprimePago(de.hybris.sdh.core.pojos.requests.
	 * ImprimeCertDeclaraRequest)
	 */
	@Override
	public String imprimePago(final ImprimeCertDeclaraRequest request)
	{
		final String urlString = configurationService.getConfiguration().getString("sdh.imprimeCertDeclara.url");
		final String user = configurationService.getConfiguration().getString("sdh.imprimeCertDeclara.user");
		final String password = configurationService.getConfiguration().getString("sdh.imprimeCertDeclara.password");
