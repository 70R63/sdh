 ...
 *
 */
public class DefaultSDHCalcGasolina2Service implements SDHCalGasolina2Service
{

	private static final Logger LOG = Logger.getLogger(DefaultSDHCalcGasolina2Service.class);
	 ...
	 */
	@Override
	public String calcGasolina2(final CalcGasolina2Request request)
	{
		final String urlString = configurationService.getConfiguration().getString("sdh.calculoGasolina2.url");
		final String user = configurationService.getConfiguration().getString("sdh.calculoGasolina2.user");
		final String password = configurationService.getConfiguration().getString("sdh.calculoGasolina2.password");
