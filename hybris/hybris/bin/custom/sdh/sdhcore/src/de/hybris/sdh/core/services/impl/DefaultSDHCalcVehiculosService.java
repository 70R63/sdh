 ...
 *
 */
public class DefaultSDHCalcVehiculosService implements SDHCalVehiculosService
{

	private static final Logger LOG = Logger.getLogger(DefaultSDHCalcVehiculosService.class);
	 ...
	 */
	@Override
	public String calcVehiculos(final CalcVehiculosRequest request)
	{
		final String urlString = configurationService.getConfiguration().getString("sdh.calcvehiculos.url");
		final String user = configurationService.getConfiguration().getString("sdh.calcvehiculos.user");
		final String password = configurationService.getConfiguration().getString("sdh.calcvehiculos.password");
