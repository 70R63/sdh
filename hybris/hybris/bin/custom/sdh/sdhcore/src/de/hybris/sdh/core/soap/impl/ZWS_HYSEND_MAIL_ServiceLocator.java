...
public class ZWS_HYSEND_MAIL_ServiceLocator extends org.apache.axis.client.Service implements de.hybirs.sdh.core.soap.ZWS_HYSEND_MAIL_Service {
    ...
    public de.hybirs.sdh.core.soap.ZWS_HYSEND_MAIL_PortType getZWS_HYSEND_MAIL() throws javax.xml.rpc.ServiceException {
    ...
    public de.hybirs.sdh.core.soap.ZWS_HYSEND_MAIL_PortType getZWS_HYSEND_MAIL(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (de.hybirs.sdh.core.soap.ZWS_HYSEND_MAIL_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
