...
public class DefaultSDHImprimePagoService implements SDHImprimePagoService
{
	 ...
	 */
	@Override
	public String imprimePago(final ImprimePagoRequest request)
	{

		final String urlString = configurationService.getConfiguration().getString("sdh.imprimePago.url");
		final String user = configurationService.getConfiguration().getString("sdh.imprimePago.user");
		final String password = configurationService.getConfiguration().getString("sdh.imprimePago.password");
