...
public class RelacionPagosICA
{
	 ...
	 *           the id_type to set
	 */
	public void setId_type(final String id_type)
	{
	 ...
	 *           the id_num to set
	 */
	public void setId_num(final String id_num)
	{
		this.id_num = id_num;
	}
	 ...
	 *           the doctyp to set
	 */
	public void setDoctyp(final String doctyp)
	{
		this.doctyp = doctyp;
	}
	 ...
	 *           the bldat to set
	 */
	public void setBldat(final String bldat)
	{
		this.bldat = bldat;
	}
	...
	/**
	 * @return the total_pgo
	 */
	public String getTotal_pgo()
	{
		return total_pgo;
	}
	...
	/**
	 * @param total_pgo
	 *           the total_pgo to set
	 */
	public void setTotal_pgo(final String total_pgo)
	{
	 ...
	 *           the waers to set
	 */
	public void setWaers(final String waers)
	{
		this.waers = waers;
	}
