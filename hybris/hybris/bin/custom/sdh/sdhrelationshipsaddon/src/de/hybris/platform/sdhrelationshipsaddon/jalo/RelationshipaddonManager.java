 ...
 *  
 */
package de.hybris.platform.sdhrelationshipsaddon.jalo;

import de.hybris.platform.core.Registry;
import de.hybris.platform.sdhrelationshipsaddon.constants.RelationshipaddonConstants;
...
/**
 * This is the extension manager of the Relationshipaddon extension.
 */
public class RelationshipaddonManager extends GeneratedRelationshipaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(RelationshipaddonManager.class.getName());
	 ...
	 */
	public static RelationshipaddonManager getInstance()
	{
		return (RelationshipaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(RelationshipaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RelationshipaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of RelationshipaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of RelationshipaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of RelationshipaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
