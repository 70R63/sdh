...
<div class="divOuterTable row no-margin">
	<div class="divTable" role="grid">
			<div class="divTableHeading hidden-xs" role="row">
				<div class="divTableCell col-xs-12 col-sm-2 col-md-3" role="columnheader">
					<spring:theme code="text.relationship.name" />
				</div>
				<div class="divTableCell col-xs-12 col-sm-6 col-md-6" role="columnheader">
					<spring:theme code="text.relationship.permissions" />
				</div>
				<div class="divTableCell col-xs-12 col-sm-2 col-md-3" role="columnheader"><span class="acc_hidden"><spring:theme code="text.relationship.actions" /></span></div>
			</div>
		...
		<c:forEach items="${results['non-poa']}" var="relationship">
				<ycommerce:testId code="RelationshipHistoryItem_showRelationships">
					...
					<div class="divTableCell col-xs-12 col-sm-2 col-md-3" role="gridcell">
							<c:choose>
						...
						<div class="divTableCell col-xs-12 col-sm-6 col-md-6" role="gridcell">
						    <user:relationshipSummaryMessage relationship="${relationship}" relationshipType="non-poa" customer="${customer}" sessionUser="${customer}"/>
						</div>
						<div class="divTableCell col-xs-12 col-sm-4 col-md-3" role="gridcell">
			...
			<c:forEach items="${results['poa-holder']}" var="relationship">
				<ycommerce:testId code="RelationshipHistoryItem_showRelationships">
					<div class="divTableRow" role="row">
						...
						<div class="divTableCell col-xs-12 col-sm-6 col-md-6" role="gridcell">
						  <user:relationshipSummaryMessage relationship="${relationship}" relationshipType="poa-holder" customer="${customer}" sessionUser="${customer}"/>
						</div>
						<div class="divTableCell col-xs-12 col-sm-4 col-md-3" role="gridcell">
							<button id="relationshipManageDetails" type="submit" class="btn btn-grey btn-block" onClick="window.location='${manageDetailsUrl}${ycommerce:encodeHTML(relationship.id)}/${ycommerce:encodeHTML(customer.customerPK)}'">
									<spring:theme code="text.relationship.manage.details" />
			...
			<c:forEach items="${results['poa-receiver']}" var="relationship">
				<ycommerce:testId code="RelationshipHistoryItem_showRelationships">
					<div  class="divTableRow" role="row">
						...
						<div class="divTableCell col-xs-12 col-sm-6 col-md-6" role="gridcell">
						   <user:relationshipSummaryMessage relationship="${relationship}" relationshipType="poa-receiver" customer="${customer}" sessionUser="${customer}"/>
						</div>
							<div class="divTableCell col-xs-12 col-sm-4 col-md-3" role="gridcell">
								<button id="relationshipManageDetails" type="submit" class="btn btn-grey btn-block" onClick="window.location='${manageDetailsUrl}${ycommerce:encodeHTML(relationship.id)}/${ycommerce:encodeHTML(customer.customerPK)}'">
									<spring:theme code="text.relationship.manage.details" />
