 ...
 */
package de.hybris.sdh.test.setup;
...
import de.hybris.sdh.test.constants.SdhTestConstants;
import de.hybris.sdh.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SdhTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/sdhtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/sdhtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/sdhtest/import/cstickets.impex");
			...
			importImpexFile(context, "/sdhtest/import/csquotes.impex");
		}
	}
}
