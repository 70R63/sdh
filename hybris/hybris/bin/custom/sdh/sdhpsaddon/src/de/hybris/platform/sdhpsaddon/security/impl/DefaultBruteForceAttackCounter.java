...
import de.hybris.platform.sdhpsaddon.security.BruteForceAttackCounter;
...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultBruteForceAttackCounter.class);//NOPMD
