...
/**
 * The class of PSFeaturedLinksComponentController.
 */
@Controller("PSFeaturedLinksComponentController")
@RequestMapping(value = ControllerConstants.Actions.Cms.PSFeaturedLinksComponent)
public class PSFeaturedLinksComponentController<C extends PSFeaturedLinksComponentModel>
		extends SubstitutingCMSAddOnComponentController<C>
{
	...
	{
		model.addAttribute("featuredLinks", component);
	}
}
