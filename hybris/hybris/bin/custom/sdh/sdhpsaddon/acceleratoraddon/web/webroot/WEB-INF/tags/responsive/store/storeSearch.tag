...
<div class="row">
	<div class="col-lg-8">
		<div class="headline"><h1><span tabindex="0"><spring:theme code="storeFinder.find.a.store" /></span></h1></div>
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<ycommerce:testId code="storeFinder_nearMe_button">
						<h2>
							<span tabindex="0"><button id="findStoresNearMe" class="btn btn-primary btn-block"
