...
<div class="display-none" id="popup_suggested_delivery_addresses_form">
    <div class="pad_left" id="popup_suggested_delivery_addresses">
        <div class="span-13 suggested_address_container">
			<h4 class="suggested_address_title"><span tabindex="0"><spring:theme code="checkout.multi.deliveryAddress.selectSuggestedAddress" htmlEscape="false"/></span></h4>
        ...
        <div class="span-13 suggested_address_container users_address_container">
			<h4 class="suggested_address_title"><span tabindex="0"><spring:theme code="checkout.multi.deliveryAddress.addressSuggestions.addressNotFound"/></span></h4>
            <div class="span-8 suggested_address">
                <ul>
