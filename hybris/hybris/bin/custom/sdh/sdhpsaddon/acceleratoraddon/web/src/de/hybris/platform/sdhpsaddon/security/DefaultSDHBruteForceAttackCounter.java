 ...
 */
public class DefaultSDHBruteForceAttackCounter implements BruteForceAttackCounter
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSDHBruteForceAttackCounter.class);//NOPMD
	...
	public DefaultSDHBruteForceAttackCounter(final Integer maxFailedLogins, final Integer cacheExpiration,
