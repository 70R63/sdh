...
<div class="copyright footer__bottom">
	<div class="container">
		<div class="row">
			<div class="col-md-1">
				<a> <img title="Bogota" alt="Bogota" class="footerimg"
					src="/bogota/_ui/addons/sdhpsaddon/responsive/theme-psalpha/images/Bogota_footer_1.svg"
					width="200" height="196">
				</a>
			</div>
			<div class="col-md-1">
				<a> <img title="Bogota" alt="Bogota" class="footerimg_gov"
					src="/bogota/_ui/addons/sdhpsaddon/responsive/theme-psalpha/images/Bogota_footer_2.svg"
					width="135" height="27">
				</a>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-sm-6 chat-footer">
				<button type="button" class="btn btn-lg pop-over pop-over-toggle"
					onclick="openChatWindow();" id="pop-over-toggle"
					data-placement="top">
	...
	<!-- Chat Module -->
	<div class="container chat-container popover-content"
		id="popover-content">
		<div
				...
				<div class="chat-module-header">
					<div>
						<span tabindex="0" class="chat-glyphicon-open"> <spring:theme
								code="chatbox.title" />
						</span> <span> <spring:theme code="chat.box.close" var="chatClose"></spring:theme>
				...
				<div class="chat-module-content">
					<div class="form-group ">
						<label for="chat-name" class="control-label required"> <spring:theme
							...
							class="chat-text form-control chat-name" name="chat.name"
							id="chat-name" data-trigger="focus">
					</div>
					<div class="form-group ">
						<label for="chat-email" class="control-label"> <spring:theme
								code="chatbox.email" />
						</label> <input type="text" value=""
							class="chat-text form-control chat-email" name="chat.email"
							id="chat-email">
					</div>
					<div class="form-group ">
						...
						<textarea
							class="chat-text form-control chat-textarea chat-message"
							name="chat.message" id="chat-message"> </textarea>
					</div>
					<spring:message code="chatbox.start.chat" var="startChatText" />
					<input type="submit" name="submit"
						class="btn btn-black btn-block btn-chat"
						value="${fn:escapeXml(startChatText)}"></input> <br />
				</div>
			</div>
		</div>
	</div>
