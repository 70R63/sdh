...
<div class="container">
	<div id="divTubular" style="display: block;">
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="form-group ">
					<input id="tipoElementoTubular" name="tipoElementoTubular"
						class="inputtextnew" aria-required="true" type="text" value=""
						maxlength="240">
				</div>
			</div>
			<div class="col-md-3">
			...
			<div class="col-md-2">
				<div class="form-group ">
					<input id="direccionTubular" name="direccionTubular"
						class="inputtextnew" aria-required="true" type="text" value=""
						maxlength="240">
				</div>
			</div>
			...
			<div class="col-md-2">
				<div class="form-group ">
					<input id="localidadTubular" name="localidadTubular"
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="form-group ">
					<input id="licenciaConstruc" name="licenciaConstruc"
						class="inputtextnew" aria-required="true" type="text" value=""
						maxlength="240">
				</div>
			</div>
			...
			<div class="col-md-2">
				<div class="form-group ">
					<input id="vigLicenConstruc" name="vigLicenConstruc"
						class="inputtextnew" aria-required="true" type="text" value=""
						maxlength="240">
				</div>
			</div>
			...
			<div class="col-md-2">
				<div class="form-group ">
					<input id="ubicacionTubular" name="ubicacionTubular"
						class="inputtextnew" aria-required="true" type="text" value=""
						maxlength="240">
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="form-group ">
					<input id="numCarasTubular" name="numCarasTubular"
						class="inputtextnew" aria-required="true" type="text" value=""
						maxlength="240">
				</div>
			</div>
