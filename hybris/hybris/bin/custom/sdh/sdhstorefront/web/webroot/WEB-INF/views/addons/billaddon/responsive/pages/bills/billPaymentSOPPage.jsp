...
<%@ taglib prefix="bills" tagdir="/WEB-INF/tags/addons/billaddon/responsive/bills" %>
<%@ taglib prefix="addOntemplate" tagdir="/WEB-INF/tags/addons/billaddon/responsive/template" %>
