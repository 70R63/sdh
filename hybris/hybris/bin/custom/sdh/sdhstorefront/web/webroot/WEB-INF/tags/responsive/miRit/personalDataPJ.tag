		...
		<div class="headline">
			<h2>
				<span tabindex="0"><spring:theme
						code="mirit.pj.personalData.title" text="Mis datos personales" /></span>
			</h2>
		</div>
	</div>
</div>
...
<form:form method="post" commandName="miRitForm" action="${formAction}">
	<div class="row">
		<div class="col-md-6">
			<div class="form-group ">
				<label class="control-label required" for="tipoDoc"> <spring:theme
						code="mirit.personalData.documentType" text="Mis datos personales" />
				</label> <select id="documentType" class="form-control" disabled="disabled">
					<option value="${miRitForm.tipoDoc }"><spring:theme
							code="register.id.types.${miRitForm.tipoDoc}" /></option>
				</select>

				<div class="help-block">
					<span id="lastName.errors" class="hidden">Seleccione un tipo
						de documento</span>
				</div>
			</div>
		</div>
		<div class="col-md-4">
			<div class="form-group ">
				...
				</label> <input id="numDoc" name="numDoc" class="form-control form-control"
					aria-required="true" disabled="disabled" type="text"
					value="${miRitForm.numDoc }" maxlength="240">
				<div class="help-block">
					<span id="lastName.errors" class="hidden">Seleccione un tipo
						de documento</span>
				</div>
		...
		<div class="col-md-10">
			<div class="form-group ">
				<input id="nombreRazonSocial3" name="nombreRazonSocial3"
					...
					value="${miRitForm.nombreRazonSocial3 }" disabled="disabled"
					maxlength="240">
				<div class="help-block">
					<span id="lastName.errors" class="hidden">Seleccione un tipo
						de documento</span>
		...
		<div class="col-md-10">
			<div class="form-group ">
				<input id="nombreRazonSocial4" name="nombreRazonSocial4"
					class="form-control form-control" aria-required="true" type="text"
					value="${miRitForm.nombreRazonSocial4 }" disabled="disabled"
					maxlength="240">
				<div class="help-block">
					<span id="lastName.errors" class="hidden">Seleccione un tipo
						de documento</span>
	...
	<div class="row">
		<div class="col-md-4">
			<div class="form-group ">
				...
				</label> <select class="form-control" disabled="disabled" id="formaJuridica"
					name="formaJuridica">
		...
		<div class="col-md-4">
			<div class="form-group ">
				<label class="control-label required" for="numeroMatriculaMercantil">
					...
					name="numeroMatriculaMercantil" class="form-control form-control"
					aria-required="true" type="text"
					value="${miRitForm.numeroMatriculaMercantil}" disabled="disabled"
					maxlength="240">
				<div class="help-block">
					<span id="lastName.errors" class="hidden">Seleccione un tipo
						de documento</span>
	...
	<div class="row">
		<div class="col-md-4">
			<div class="form-group ">
				<label class="control-label required" for="fechaLiquidacion">
					...
					class="form-control form-control" aria-required="true" type="text"
					value="${miRitForm.fechaLiquidacion}" disabled="disabled"
					maxlength="240">
				<div class="help-block">
					<span id="lastName.errors" class="hidden">Seleccione un tipo
						de documento</span>
		...
		<div class="col-md-4">
			<div class="form-group ">
				<label class="control-label required" for="tipoRetenedor"> <spring:theme
						code="mirit.pj.retainerType" />
				</label> <select class="form-control" disabled="disabled" id="tipoRetenedor"
					name="tipoRetenedor">
