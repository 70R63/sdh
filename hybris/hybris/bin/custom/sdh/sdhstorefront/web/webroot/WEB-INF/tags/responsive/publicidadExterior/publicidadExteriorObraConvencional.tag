		...
		<div class="col-md-4">
			<div class="form-group ">
				<label class="control-label"><spring:theme
					...
					id="obraConvencionaltipoPublici" name="obraConvencionaltipoPublici"
					class="form-control" aria-required="true" type="text"
		...
		<div class="col-md-4">
			<div class="form-group ">
				<label class="control-label"><spring:theme
					...
					id="obraConvencionalAvisoLumino" name="obraConvencionalAvisoLumino"
					class="form-control" aria-required="true" type="text"
		...
		<div class="col-md-4">
			<div class="form-group ">
				<label class="control-label"><spring:theme
					...
					id="obraConvencionalOrientacion" name="obraConvencionalOrientacion"
					class="form-control" aria-required="true" type="text"
