...
<%@ taglib prefix="relations" tagdir="/WEB-INF/tags/addons/relationshipaddon/responsive/relationship"%>
<%@ taglib prefix="cancelPendingRequest" tagdir="/WEB-INF/tags/addons/relationshipaddon/responsive/cancelPendingRequest"%>
