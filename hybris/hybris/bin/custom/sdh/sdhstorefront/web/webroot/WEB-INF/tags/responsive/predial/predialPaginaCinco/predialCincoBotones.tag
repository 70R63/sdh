...
<c:if test="${fn:substring(predialFormcinco.opcionuso,0,2) == '01' && predialFormcinco.indicadorspac == 'X'}">
			...
			<div class="col-md-12 centercol-md-8 text-center">
				...
				<c:if test="${flagSPAC eq true}">
					<button class="btn btn-primary btn-lg btnspac" type="submit" id="btnspac"
                        name="pagar" value="pagar" data-numbp="${predialFormcinco.numBP}" data-numForm="${predialFormcinco.numFrom}" data-anio="${predialFormcinco.anioGravable}" data-obj="${predialFormcinco.objetocontrato}" data-reimpresion="">
