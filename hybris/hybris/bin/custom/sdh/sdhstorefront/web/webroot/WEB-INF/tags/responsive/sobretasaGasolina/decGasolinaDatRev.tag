...
<div class="row">
		...
		<div class="col-md-4">
			<div class="form-group ">
				<label class="control-label"><spring:theme
					...
					type="text" value="${dataForm.revisor.nombres}" maxlength="240"
					readonly="readonly">
			</div>
		</div>
	</div>
		...
		<div class="col-md-4">
			<div class="form-group ">
				<label class="control-label"><spring:theme
					...
					id="nombre" name="nombre" class="form-control" aria-required="true"
					type="text" value="${dataForm.revisor.tipoDocDESC}" maxlength="240"
					readonly="readonly">
			</div>
		</div>
	</div>
		...
		<div class="col-md-4">
			<div class="form-group ">
				<label class="control-label"><spring:theme
					...
					aria-required="true" type="text" value="${dataForm.revisor.numDoc}"
	...
	<div class="row">
		<div class="col-md-4">
			<div class="form-group ">
				<label class="control-label"><spring:theme
						code="impuestos.decGasolina.DatosRevisor.numeroTarjetaProf" /></label> <input
					id="numeroTarjetaProf" name="numeroTarjetaProf"
