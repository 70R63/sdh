...
<div class="row">
	<div class="headline">
		<h2>
			<span><spring:theme code="delineacion.urbana.detail.title" /></span>
		</h2>
	</div>
</div>
...
<form:form>
	<div class="row">
		...
		<div class="col-md-4">
			<button type="submit" class="btn btn-primary btn-lg" id="" name="" value="Buscar">
	...
	<div class="col-md-4 col-md-offset-4 center">
			<button class="btn btn-primary btn-lg backToHome" id="" name="" value="Regresar">
