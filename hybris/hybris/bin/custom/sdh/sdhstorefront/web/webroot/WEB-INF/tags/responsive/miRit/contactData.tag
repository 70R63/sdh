...
<script>
	function menuAutoSearch() {
		...
		document.getElementById("address.assistant.output.street").value = streetType
				+ " "
				+ section1
				+ " "
				+ section2
	...
	function departmentChanged() {
		...
		$('#u5058_input').find('option').remove();
		...
		$('#u5073_input').find('option').remove();
	...
	function setAddress() {
		...
		if (addressType == "notificacion") {
			document.getElementById("direccionNotificacion").value = document
					.getElementById("address.assistant.output").value;
			document.getElementById("direccionNotificacionStreet").value = document
					.getElementById("address.assistant.output.street").value;
			document.getElementById("direccionNotificacionSuppl1").value = document
					.getElementById("address.assistant.output.spl1").value;
			document.getElementById("direccionNotificacionSuppl2").value = document
					.getElementById("address.assistant.output.spl2").value;

			document.getElementById("countryDireccionNotificacion").value = document
					.getElementById("countrySelect").value;
			document.getElementById("deparmentDireccionNotificacion").value = document
					.getElementById("deparmentSelect").value;

			$("#municipioDireccionNotificacion").find('option').remove();
			var o = new Option($('#u5058_input option:selected').text(), $(
					'#u5058_input').val());
			/// jquerify the DOM object 'o' so we can use the html method
			...
			var o = new Option($('#u5073_input option:selected').text(), $(
					'#u5073_input').val());
			/// jquerify the DOM object 'o' so we can use the html method
			...
			document.getElementById("direccionContacto").value = document
					.getElementById("address.assistant.output").value;
			document.getElementById("direccionContactoStreet").value = document
					.getElementById("address.assistant.output.street").value;
			document.getElementById("direccionContactoSuppl1").value = document
					.getElementById("address.assistant.output.spl1").value;
			document.getElementById("direccionContactoSuppl2").value = document
					.getElementById("address.assistant.output.spl2").value;

			document.getElementById("countryDireccionContacto").value = document
					.getElementById("countrySelect").value;
			document.getElementById("deparmentDireccionContacto").value = document
					.getElementById("deparmentSelect").value;
	...
	function addComplement() {
		...
		if (complementos == 0) {
			document.getElementById("address.assistant.output").value = document
					.getElementById("address.assistant.output").value
					+ " " + complement + " " + complementText;
			document.getElementById("address.assistant.output.spl1").value = complement
					+ " " + complementText;
			complementos++;
			...
			document.getElementById("address.assistant.output").value = document
					.getElementById("address.assistant.output").value
					+ " " + complement + " " + complementText;
			document.getElementById("address.assistant.output.spl2").value = document
					.getElementById("address.assistant.output.spl2").value
					+ complement + " " + complementText;
			complementos++;
...
<!-- 				cambio -->
					<div class="col-md-3">
						<div class="form-group ">
							...
							<label class="control-label required" for="direccionContacto">
								...
								value="${miRitForm.direccionContacto.STREET}"> <input
								id="direccionContactoSuppl1" name="direccionContactoSuppl1"
								type="hidden"
								data-original="${miRitForm.direccionContacto.STR_SUPPL1 }"
								value=" ${miRitForm.direccionContacto.STR_SUPPL1 } "> <input
								id="direccionContactoSuppl2" name="direccionContactoSuppl2"
								type="hidden"
								data-original="${miRitForm.direccionContacto.STR_SUPPL2 }"
								value="${miRitForm.direccionContacto.STR_SUPPL2 }">
				...
				<div id="addressAssistant"
					...
					<input id="address.assistant.output" name="addressAssistantOutput"
						...
						id="address.assistant.output.spl1"
						name="address.assistant.output.spl1"
						class="form-control form-control" type="hidden" /> <input
						id="address.assistant.output.spl2"
						name="address.assistant.output.spl2"
						class="form-control form-control" type="hidden" /> <br>
					<div class="row">
						<div class="col-md-2">
							<div class="form-group ">
								<label class="control-label " for="u5067_input"> <spring:theme
										code="mirit.contactData.addressType" />
								</label> <select id="u5067_input" class="form-control"
									onchange="cancelAddAddress();">
...
<!-- 					</div> -->
					<div class="row">
						<div class="col-md-2">
							<div class="form-group ">
								...
								<label class="control-label " for="countrySelect"> <spring:theme
										code="mirit.contactData.country" />
								</label> <select id="countrySelect" class="form-control"
					...
					<div class="row">
						<div class="col-md-2">
							<div class="form-group ">
								<label class="control-label " for="deparmentSelect"> <spring:theme
										code="mirit.contactData.department" />
								</label> <select id="deparmentSelect" class="form-control "
						...
						<div class="col-md-2">
							<div class="form-group ">
								<label class="control-label " for="u5058_input"> <spring:theme
										code="mirit.contactData.county" />
								</label> <select id="u5058_input" class="form-control"
									onchange="municipioChanged();">
									<option value="">Seleccionar</option>
								</select>
								<div class="help-block">
									<span id="lastName.errors" class="hidden">Seleccione un
						...
						<div class="col-md-2">
							<div class="form-group ">
								<label class="control-label " for="u5073_input"> <spring:theme
										code="mirit.contactData.postalCode" />
								</label> <select id="u5073_input" class="form-control" onchange="">
									<option value="">Seleccionar</option>
								</select>
								<div class="help-block">
									<span id="lastName.errors" class="hidden">Seleccione un
					...
					<div class="row">
						<div class="col-md-2">
							<div class="form-group ">
								<label class="control-label " for="u5059_input"> <spring:theme
										code="mirit.addresshelper.tipo" />
								</label> <select id="u5059_input"
									class="form-control addressHelperField"
									onchange="menuAutoSearch();">
						...
						<div class="col-md-1">
							<div class="form-group ">
								<label class="control-label " for="u5062_input"> <spring:theme
										code="mirit.addresshelper.letra" />
								</label> <select id="u5062_input"
									class="form-control addressHelperField"
									onchange="menuAutoSearch();">
									<option selected="" value="">Seleccionar</option>
						...
						<div class="col-md-1">
							<div class="form-group ">
								<label class="control-label " for="u5061_input"> <spring:theme
										code="mirit.addresshelper.bis" />
								</label> <select id="u5061_input"
									class="form-control addressHelperField"
									onchange="menuAutoSearch();">
									<option selected="" value="">Seleccionar</option>
						...
						<div class="col-md-1">
							<div class="form-group ">
								<label class="control-label " for="u5063_input"> <spring:theme
										code="mirit.addresshelper.letra" />
								</label> <select id="u5063_input"
									class="form-control addressHelperField"
									onchange="menuAutoSearch();">
									<option selected="" value="">Seleccionar</option>
									<option value="A">A</option>
						...
						<div class="col-md-1">
							<div class="form-group ">
								<label class="control-label " for="u5064_input"> <spring:theme
										code="mirit.addresshelper.zona" />
								</label> <select id="u5064_input"
									class="form-control addressHelperField"
									onchange="menuAutoSearch();">
									<option selected="" value="">Seleccionar</option>
						...
						<div class="col-md-1">
							<div class="form-group ">
								<label class="control-label " for="u5065_input"> <spring:theme
										code="mirit.addresshelper.letra" />
								</label> <select id="u5065_input"
									class="form-control addressHelperField"
									onchange="menuAutoSearch();">
									<option selected="" value="">Seleccionar</option>
									<option value="A">A</option>
						...
						<div class="col-md-1">
							<div class="form-group ">
								<label class="control-label " for="u5079_input"> <spring:theme
										code="mirit.addresshelper.zona" />
								</label> <select id="u5079_input"
									class="form-control addressHelperField"
									onchange="menuAutoSearch();">
									<option selected="" value="">Seleccionar</option>
									<option value="Sur">Sur</option>
					...
					<div class="form-group ">
						<label class="control-label "><spring:theme
								code="mirit.contactData.selectRequieredFields" /> </label>
					</div>
					<div class="row">
						<div class="col-md-3">
							<div class="form-group ">
								<label class="control-label " for="u5066_input"> <spring:theme
										code="mirit.addresshelper.tipoComplemento" />
								</label> <select id="u5066_input"
									class="form-control addressHelperField" onchange="">
									<option selected="" value="">Seleccionar</option>
						...
						<div class="col-md-3">
							<div class="form-group ">
								...
								<button
									class="btn btn-primary btn-lg  form-control  addressHelperField"
									type="button" onclick="addComplement();">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="col-md-4" id="divTelMovil" style="display: block">
							<label class="control-label" for="telefono_movil"> <spring:theme code="mirit.contactData.telefono.movil" /></label>
							<input id="telefono_movil_original" name="telefono_movil_original" class="newalto form-control" type="hidden" value="${miRitForm.telefono[0].TEL_NUMBER}" maxlength="240" disabled="disabled">
							<input id="telefono_movil" name="telefono_movil" class="newalto form-control" type="text" value="${miRitForm.telefono[0].TEL_NUMBER}" maxlength="240" onkeyup="ajustar(this)">
						</div>
						<div class="col-md-4" id="divTelOficina" style="display: block">
							<label class="control-label" for="telefono_oficina"><spring:theme code="mirit.contactData.telefono.oficina" /></label>
							<input id="telefono_oficina_original" name="telefono_oficina_original" class="newalto form-control" type="hidden" value="${miRitForm.telefono[1].TEL_NUMBER}" maxlength="240" disabled="disabled">
							<input id="telefono_oficina" name="telefono_oficina" class="newalto form-control" type="text" value="${miRitForm.telefono[1].TEL_NUMBER}" maxlength="240" onkeyup="ajustar(this)">
							<label class="control-label required" for="extensionTelefono"><spring:theme code="mirit.contactData.extension" /></label> 
							<input id="telefono_oficina_ext_original" name="telefono_oficina_ext_original" class="newalto form-control" aria-required="true" type="hidden" value="${miRitForm.telefono[1].TEL_EXTENS}" maxlength="240" disabled="disabled">
							<input id="telefono_oficina_ext" name="telefono_oficina_ext" class="newalto form-control" aria-required="true" type="text" value="${miRitForm.telefono[1].TEL_EXTENS}" maxlength="240" onkeyup="ajustar(this)">
						</div>
						<div class="col-md-4" id="divTelFijo" style="display: block">
							<label class="control-label" for="telefono_fijo"><spring:theme code="mirit.contactData.telefono.fijo" /></label>
							<input id="telefono_fijo_original" name="telefono_fijo_original" class="newalto form-control" type="hidden" value="${miRitForm.telefono[2].TEL_NUMBER}" maxlength="240" disabled="disabled">
							<input id="telefono_fijo" name="telefono_fijo" class="newalto form-control" type="text" value="${miRitForm.telefono[2].TEL_NUMBER}" maxlength="240" onkeyup="ajustar(this)"> 
						</div>
					</div>
				</div>
				<br>
								...
								<div class="col-12 col-md-2">
									<div class="form-group ">
										<button class="btn btn-secondary btn-lg btn-block "
											...
											<spring:theme code="mirit.contactData.addSocialNetwork" />
										</button>
									</div>
								</div>
