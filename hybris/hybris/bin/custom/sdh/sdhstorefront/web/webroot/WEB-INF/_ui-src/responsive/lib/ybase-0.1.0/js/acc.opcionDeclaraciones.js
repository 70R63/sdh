ACC.opcionDeclaraciones = {
	...
	obtener_desc_consecutivo: function(info_input) {
		...
		if (info_input != null) {
			...
			reteIca_consecutivo = info_valor;
		}

		return reteIca_consecutivo;
	},
...
//					if (confirm('La Declaración se ha presentado correctamente')) {
//							if (confirm('Visualizar cupones de SPAC para realizar pago.')) {
//						// Save it!
...
//				currentUrl = currentUrl.split('contribuyentes')[0];
//			}
//
//			window.location.href = currentUrl + "contribuyentes/consultas/obligaciones";
//					} else {
//						// Do nothing!
