...
<%-- 		<script type="text/javascript" src="${commonResourcePath}/js/acc.quote.js"></script> --%>
		...
		<script type="text/javascript" src="${commonResourcePath}/js/acc.reportesTerceroAutorizado.js"></script>
		...
		<script type="text/javascript" src="${commonResourcePath}/js/acc.spinner.js"></script>
		...
		<script type="text/javascript" src="${commonResourcePath}/js/acc.retencionesPracticadas.js"></script>
