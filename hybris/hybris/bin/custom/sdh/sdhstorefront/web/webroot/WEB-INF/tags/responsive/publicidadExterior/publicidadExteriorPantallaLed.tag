	...
	<div id="divPantallaLed" style="display: none;">
		...
		<div class="row">
			<div class="col-md-2">
				<div class="form-group">
					<label class="control-label"><spring:theme
							code="publicidad.exterior.pantalla.address" text="Direcci�n" /></label>
			...
			<div class="col-md-2">
				<div class="form-group">
					<label class="control-label"><spring:theme
							...
							text="C�digo postal" /></label> <input id="pantallaLedCodPostal"
			...
			<div class="col-md-2">
				<div class="form-group">
					<label class="control-label"><spring:theme
							code="publicidad.exterior.pantalla.ubicacion" text="Ubicaci�n" /></label>
			...
			<div class="col-md-2">
				<div class="form-group">
					<label class="control-label"><spring:theme
							...
							text="Matr�cula inmobilaria" /></label> <input id="pantallaLedMatricula"
		...
		<div class="row">
			<div class="col-md-2">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						id="pantallaLedChip" name="pantallaLedChip"
						class="form-control newalto" aria-required="true" type="text"
						value="" maxlength="240" disabled>
				</div>
			</div>
			...
			<div class="col-md-2">
				<div class="form-group">
					<label class="control-label"><spring:theme
							...
							text="Orientaci�n visual" /></label> <input
			...
			<div class="col-md-2">
				<div class="form-group">
					<label class="control-label"><spring:theme
							code="publicidad.exterior.pantalla.areaTotal" text="�rea total" /></label>
