	...
	<form:form action="">
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.actnosubPA) }">
			<div class="row deducciones">
				<div class="col-md-3">
					<select id="" class="form-control deducci" style="height: 48px; text-transform: none !important; font-size: 14px !important">
						<option value="actnosubPA">1.- Actividad no sujeta por la producción Primaria Agricola</option>
					</select>
				</div>
	
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.actnosubPA}"/>
				</div>
				<div class="col-md-1">
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.enajActFijo) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.enajActFijo}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						 <img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.exportBienes) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.exportBienes}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						 <img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.exportServ) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.exportServ}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						 <img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.actnosub39) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.actnosub39}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						 <img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.actnosubPH) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.actnosubPH}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						 <img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.juegoSuerteAzar) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.juegoSuerteAzar}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						 <img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.donaciones) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.donaciones}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						 <img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.exenActos) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.exenActos}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						 <img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.baseGravEsp) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.baseGravEsp}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						 <img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.ingrActConsorc) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.ingrActConsorc}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						 <img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.diviNOGiroOrd) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.diviNOGiroOrd}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						 <img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.exenVictima) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.exenVictima}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						 <img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.correcMoneda) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.correcMoneda}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
...
<!-- 							style="width: 25px"></img>  -->
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.reintegro) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.reintegro}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
<!-- 						<img onclick="adddeducciones()" -->
...
<!-- 							style="width: 25px"></img>  -->
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.salarios) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.salarios}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
<!-- 						<img onclick="adddeducciones()" -->
...
<!-- 							style="width: 25px"></img>  -->
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.devoluciones) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.devoluciones}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
							<img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.rebajas) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.rebajas}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						<img class="delededucciones"
		...
		<c:if test="${ '0.00' ne fn:trim(infoDeclara.deducciones.descuentos) }">
			<div class="row deducciones">
				...
				<div class="col-md-3">
					<input class="form-control valordedu" type="text" value="${infoDeclara.deducciones.descuentos}"/>
				</div>
				<div class="col-md-1">
					<div class="form-group ">
						<img class="delededucciones"
