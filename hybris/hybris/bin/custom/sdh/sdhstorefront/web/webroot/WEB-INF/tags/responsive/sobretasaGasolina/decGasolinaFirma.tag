			...
			<div class="col-md-12 mt-3">
					...
					<div class="col-md-3" style="margin-top: 18px">
						<div class="form-check">
							<label class="form-check-label"
								...
								<input onclick="IDhabradio()" type="checkbox" name="regimen"
								id="selectobligado" class="form-check-input mr-2"
								style="visibility: visible !important; min-height: 4px !important; margin-left: 12px;">
								<spring:theme code="gasolina.declaracion.firma.obligado" />
							</label>
						</div>
					</div>
					<div class="col-md-3">
				...
				<div class="row mt-3">
					...
					<div class="col-md-2">
						<div class="form-group">
							<label class="control-label  margen20"><spring:theme
									code="gasolina.declaracion.firma.numtarjeta" /></label> <input
