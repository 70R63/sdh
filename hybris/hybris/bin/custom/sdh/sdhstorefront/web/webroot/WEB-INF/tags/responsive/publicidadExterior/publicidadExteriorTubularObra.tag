			...
			<div class="col-md-4">
				<div class="form-group ">
					<label class="control-label "><spring:theme
						...
						name="tubularObraLicenciaConstruc" class="form-control"
			...
			<div class="col-md-4">
				<div class="form-group ">
					<label class="control-label "><spring:theme
						...
						type="text" value="${publicidadForm.chip}" maxlength="240"
						disabled>
				</div>
			</div>
		</div>
			...
			<div class="col-md-4">
				<div class="form-group ">
					<label class="control-label "><spring:theme
						...
						name="tubularObraVigLicenConstruc" class="form-control"
						type="text" value="" maxlength="240" disabled>
				</div>
			</div>
