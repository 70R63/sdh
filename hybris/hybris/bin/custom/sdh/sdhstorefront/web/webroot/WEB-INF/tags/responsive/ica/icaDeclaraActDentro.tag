			...
			<div class="headline">
				<h2>
					<span class="col-md-10 "><spring:theme
							code="ica.declaracion.actidentro.titulo" /></span>
				</h2>
			</div>
		</div>
	</div>
							...
							<tr>
								<td><label class="control-label text-capitalize !important"
									style="width: 70px;"><spring:theme
											code="ica.declaracion.actidentro.acti" /></label></td>
								<td><label class="control-label text-capitalize !important"><spring:theme
											code="ica.declaracion.actidentro.ciiu" /></label></td>
								<td><label class="control-label text-capitalize !important"><spring:theme
											code="ica.declaracion.actidentro.deno" /></label></td>
								<td><label class="control-label text-capitalize !important"><spring:theme
											code="ica.declaracion.actidentro.tarifa" /></label></td>
								<td><label class="control-label text-capitalize !important"><spring:theme
											code="ica.declaracion.actidentro.inggrav" /></label></td>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td><input type="checkbox" name="regimen" id=""
									...
									disabled size="10"></td>
								<td><select id="" style="width: 300px;">
										<option value=" ">&nbsp;</option>
										<option
										...
										<option value="123 - Cultivo de café">123 - Cultivo
											de café</option>
										...
										<option
											...
											- Cultivo de palma para aceite (palma africana) y otros
											frutos oleaginosos</option>
										<option
										...
										<option
											...
											- Actividades de apoyo para la extracción de petróleo y de
											gas natural</option>
										<option
										...
										<option value="1061 - Trilla de café">1061 - Trilla
											de café</option>
										<option
										...
										<option
											...
											- Fabricación de formas básicas de caucho y otros productos
											de caucho n.c.p.</option>
										<option
										...
										<option
											...
											- Fabricación de equipo de irradiación y equipo electrónico
											de uso médico y terapéutico</option>
										<option
										...
										<option
											value="2750 - Fabricación de aparatos de uso domestico">2750
										...
										<option
											...
											- Fabricación de cojinetes, engranajes, trenes de engranajes
											y piezas de transmisión</option>
										<option
										...
										<option
											...
											- Fabricación de instrumentos, aparatos y materiales médicos
											y odontológicos (incluido mobiliario)</option>
										...
										<option
											value="3530 - Suministro de vapor y aire acondicionado">3530
										...
										<option
											value="4511 - Comercio de vehículos automotores nuevos">4511
											- Comercio de vehículos automotores nuevos</option>
										<option
											value="4512 - Comercio de vehículos automotores usados">4512
										...
										<option
											...
											cauchos y plásticos en formas primarias y productos químicos
											de uso agropec</option>
										<option
										...
										<option
											...
											consumo en establecimientos especializados</option>
										<option
										...
										<option
											...
											(incluye artículos de piel) en establecimientos
										...
										<option
											value="5611 - Expendio a la mesa de comidas preparadas">5611
										...
										<option
											...
											cinematográficas, videos, programas, anuncios y comerciales
											de televisión&nbsp; (excepto p</option>
										<option
										...
										<option
											...
											servicios financieros n.c.p.</option>
										<option
										...
										<option
											value="9499 - Actividades de otras asociaciones n.c.p.">9499
										...
										<option
											...
											- Lavado y limpieza, incluso la limpieza en seco, de
											productos textiles y de piel</option>
										<option
										...
										<option
											...
											extraterritoriales signatarios de la Convención de Viena</option>
										<option
										...
										<option
											...
											- Fabricación de artículos de piel (excepto prendas de
											vestir)</option>
										<option
										...
										<option
											...
											drogas, medicamentos, text</option>
										<option
										...
										<option
											...
											- Comercio al por menor de productos cosméticos y artículos
											de tocador en establecimientos especializados (excepto
										...
										<option
											...
											- Comercio al por menor de cigarrillos y licores en puestos
											de venta móviles</option>
										<option
										...
										<option
											...
											- Otros tipos de comercio al por menor no realizado en
											establecimientos, puestos de venta o mercados de cigarrillos
											y licores; ven</option>
										<option
										...
										<option
											...
											contribuyentes que cumplen condiciones del Acuerdo 98 de
											2003)</option>
										<option
										...
										<option
											...
											- Actividades de administración empresarial en el ejercicio
											de una profesión liberal</option>
										...
										<option
											...
											actividades conexas de consultoría técnica</option>
										<option
											...
											- Actividades de arquitectura e ingeniería y otras
											actividades conexas en el ejercicio de una profesión liberal</option>
										<option
										...
										<option
											...
											- Investigaciones y desarrollo experimental en el campo de
											las ciencias naturales y la ingeniería&nbsp; como consultoría
											profesional</option>
										<option
											...
											- Investigaciones y desarrollo experimental en el campo de
											las ciencias naturales y la ingeniería&nbsp; en el ejercicio
											de una profesió</option>
										<option
											...
											consultoría profesional</option>
										<option
											...
											- Investigaciones y desarrollo experimental en el campo de
											las ciencias sociales y las humanidades&nbsp; en el ejercicio
											de una profesi</option>
										<option
										...
										<option
											...
											(excepto entidades e instituciones promotoras y prestadoras
											de servicio</option>
										<option
										...
										<option
											...
											- Actividades de juegos de destreza, habilidad, conocimiento
											y fuerza</option>
										<option
								...
								<td><input class="inputtextnew" disabled="disabled"
									type="text" style="width: 204px;" /></td>
