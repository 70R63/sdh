...
<!-- 						<li class="nav-item new_tab"><a href="#tab1" -->
<%-- 							class="nav-link active new_active" data-toggle="tab"><span><spring:theme --%>
<%-- 										code="mibuzon.mensajes.mensajes" /></span><span --%>
<!-- 								class="badge badge-light">12</span></a></li> -->

<!-- 						<li class="nav-item new_tab"><a href="#tab2" -->
<%-- 							class="nav-link new_active" data-toggle="tab"><span><spring:theme --%>
<%-- 										code="mibuzon.notificaciones.notifica" /></span><span --%>
<!-- 								class="badge badge-light">1</span></a></li> -->
<!-- 					</ul> -->
