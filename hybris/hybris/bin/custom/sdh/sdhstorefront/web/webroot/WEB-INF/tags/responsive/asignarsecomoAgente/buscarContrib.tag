...
<div class="container_new_page">
	<div class="row mt-3">
		<div class="col-md-12 mt-3">
			<div class="headline">
				<h2>
					<span><spring:theme code="autorizado.asignarse.inicial.titulo" /></span>
				</h2>
			</div>
		</div>
	</div>
		...
		<div class="col-md-12"
			...
			<div class="form-group">
				<label class="control-label"><spring:theme
						code="autorizado.asignarse.inicial.nota" /><br><spring:theme
						code="autorizado.asignarse.inicial.nota2" /></label>
			</div>
		</div>
	</div>
</div>
<div id="acordeon" class="container">
	<div class="card cardmirit ">
				...
				<button class="btn btn-link miritmenu" data-toggle="collapse"
					...
					<h4>
						<span tabindex="0"><spring:theme
								code="autorizado.asignarse.buscar.titulo" text="" /></span>
					</h4>
				</button>
			</h5>
		</div>
		...
		<div class="col-md-12"
			...
			<div class="form-group">
				<label class="control-label"><spring:theme
						code="autorizado.asignarse.inicial.nota3" /></label>
			</div>
		</div>
	</div>
				<div class="row">
					<div class="col-md-2">
						<div class="form-group ">
							<label class="control-label"> <spring:theme
									code="autorizado.asignarse.buscar.tipdoc" text="" /></label> <select id=""
					...
					<div class="col-md-2">
						<div class="form-group ">
							<label class="control-label required" for="numDoc"> <spring:theme
									code="autorizado.asignarse.buscar.numdoc" />
					...
					<div class="col-md-2">
						<div class="form-group ">
							<label class="control-label required"> <spring:theme
									code="autorizado.asignarse.buscar.fecexpe" />
							</label> <input id="" name="" class="newalto form-control"
								aria-required="true" type="text" value="" maxlength="240"
				...
				<div class="row">
					<div class="col-md-2">
						<button class="btn btn-secondary" type="button" id="">
							<spring:theme code="autorizado.asignarse.buscar.cancelar" />
						</button>
					</div>
					<div class="col-md-2">
						<button class="btn btn-primary" type="button" id="">
							<spring:theme code="autorizado.asignarse.buscar.buscar" />
						</button>
					</div>
