...
<div class="container">
	...
	<div class="row">
		<div class="headline">
			<h2 align="center">
				<span><spring:theme
						code="representantes.info.sanciones.inicial.titulo" /></span>
	...
	<div class="row">
		<div class="form-group">
			<label class="control-label"><spring:theme
					code="representantes.info.sanciones.inicial.obteninfo" /></label>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-4">
			<div class="form-group">
				<label class="control-label required"><spring:theme
						code="representantes.info.sanciones.inicial.impreportar" /></label> <select
		...
		<div class="col-md-4">
			<div class="form-group">
				<label class="control-label required"><spring:theme
						code="representantes.info.sanciones.inicial.anigrav" /></label> <select
		...
		<div class="col-md-3  col-md-offset-1 centercol-md-8 text-right">
			<div class="form-group">
				<button class="btn btn-primary btn-block" id="" name=""
					value="cancelar">
					<spring:theme code="representantes.info.sanciones.inicial.cacelar" />
				</button>
			</div>
		</div>
		<div class="col-md-3">
			<div class="form-group">
				<button type="submit" class="btn btn-primary btn-block" id=""
					...
					<spring:theme
						code="representantes.info.sanciones.inicial.continuar" />
				</button>
			</div>
		</div>
	</div>
