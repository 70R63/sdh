...
<c:if test="${predialFormcua.anioGravable != '2022'}">
	...
	<div class="container">
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						disabled type="text"
						value="${predialFormcua.estrLiquidacionPrivada.valorImpuestoCargo}"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						value="${predialFormcua.estrLiquidacionPrivada.descuentoIncrementoDiferencial}"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						class="newalto form-control" disabled type="text"
						value="${predialFormcua.estrLiquidacionPrivada.valorImpuestoAjustadoActual}"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						value="${predialFormcua.estrLiquidacionPrivada.sancion}"
						maxlength="240"></input>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><spring:theme
							code="predialtres.liquidacionpriv.saldo" /></label> <input id="Sancion"
						name="" class="newalto form-control" disabled type="text"
						value="${predialFormcua.estrLiquidacionPrivada.totalSaldoCargo}"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						type="text"
						value="${predialFormcua.estrLiquidacionPrivada.valorAPagar}"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						type="text"
						value="${predialFormcua.estrLiquidacionPrivada.descuentoProntoPago}"
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						disabled type="text"
						value="${predialFormcua.estrLiquidacionPrivada.descuentoAdicional}"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						type="text"
						value="${predialFormcua.estrLiquidacionPrivada.intereses}"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						type="text"
						value="${predialFormcua.estrLiquidacionPrivada.totalPagar}"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						disabled type="text"
						value="${predialFormcua.estrLiquidacionPrivada.valorAporteVoluntario}"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						disabled type="text"
						value="${predialFormcua.estrLiquidacionPrivada.totalPagoVoluntario}"
						maxlength="240"></input>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-3">
				<c:if
					test="${predialFormcua.controlCampos.liquidacionPrivada != true}">
