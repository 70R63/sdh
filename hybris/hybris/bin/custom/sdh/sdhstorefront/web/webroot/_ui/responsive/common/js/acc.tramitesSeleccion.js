		...
		if(infoResponse.infoCasos.length > 0){
			$.each(infoResponse.infoCasos, function (index,value){
				$('#tableInfo').append("<tr>"+ 
						...
						'<td><input style="width: 123px !important" class="inputtextnew" disabled="disabled" type="text" size="40" value="' + value.num_radicado + '" /></td>'+
						'<td><input style="width: 195px !important" class="inputtextnew" disabled="disabled" type="text" size="100" value="' + value.tramite + '" /></td>'+
						'<td><input style="width: 135px !important" class="inputtextnew" disabled="disabled" type="text" size="40" value="' + value.estatus + '" /></td>'+
						 "</tr>");
				mostrarTabDocs = true;
			});			
		}
