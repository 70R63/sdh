						...
						<tbody>
							<tr>
								<td><input class="inputtextnew tableident"
									...
									value="${representadoData.infoContrib.tipoDoc}" /></td>
								<td><input class="inputtextnew tablenumiden"
									disabled="disabled" type="text" size="30"
									value="${representadoData.infoContrib.numDoc}" /></td>
								<c:choose>
									<c:when test="${empty representadoData}">
									...
									<c:otherwise>
										<td><input class="inputtextnew tablenombre"
											disabled="disabled" type="text" size="30"
											value="${representadoData.completeName}" /></td>
									</c:otherwise>
								</c:choose>
												...
												<tr>
													...
													<c:choose>
														<c:when test="${eachDeclaracion.impuesto eq '0007'}">
															<td ><a href="<c:url value="/contribuyentes/publicidadexterior/declaracion/show?representado=${representadoData.infoContrib.numBP}&numForm=${eachDeclaracion.idDeclaracion}" />">Ver</a></td>
														</c:when>
														<c:when test="${eachDeclaracion.impuesto eq '0005'}">
															<td ><a href="<c:url value="/contribuyentes/sobretasa-gasolina/declaracion/show?representado=${representadoData.infoContrib.numBP}&numForm=${eachDeclaracion.idDeclaracion}" />">Ver</a></td>
														</c:when>
														<c:when test="${eachDeclaracion.impuesto eq '0003'}">
															<td ><a href="<c:url value="/contribuyentes/ica/declaracion/show?representado=${representadoData.infoContrib.numBP}&numForm=${eachDeclaracion.idDeclaracion}&periodoSeleccionado=${eachDeclaracion.periodo}&anoGravable=${eachDeclaracion.anioGravable}" />">Ver</a></td>
														</c:when>
														<c:when test="${eachDeclaracion.impuesto eq '0004'}">
															<td ><a href="<c:url value="/reteica/declaracion/show?representado=${representadoData.infoContrib.numBP}&numForm=${eachDeclaracion.idDeclaracion}&anoGravable=${eachDeclaracion.anioGravable}&perRepor=${eachDeclaracion.periodo}" />">Ver</a></td>
														</c:when>
														<c:when test="${eachDeclaracion.impuesto eq '0006'}">
															<td ><a href="<c:url value="/contribuyentes/delineacionurbana/declaracion/show?representado=${representadoData.infoContrib.numBP}&numForm=${eachDeclaracion.idDeclaracion}&anoGravable=${eachDeclaracion.anioGravable}&perRepor=${eachDeclaracion.periodo}" />">Ver</a></td>
														</c:when>														
														<c:when test="${eachDeclaracion.impuesto eq '0002'}">
															<td ><a href="<c:url value="/contribuyentes/sobrevehiculosautomotores/declaracion/show?representado=${representadoData.infoContrib.numBP}&numForm=${eachDeclaracion.idDeclaracion}" />">Ver</a></td>
														</c:when>
														<c:when test="${eachDeclaracion.impuesto eq '0001'}">
															<td ><a href="<c:url value="/contribuyentes/predialunificado/show?representado=${representadoData.infoContrib.numBP}&numForm=${eachDeclaracion.idDeclaracion}" />">Ver</a></td>
														</c:when>
														<c:otherwise>
															<td style="color: #2196f3; text-decoration: underline !important; font-size: 14px;">Ver</td>
														</c:otherwise>
