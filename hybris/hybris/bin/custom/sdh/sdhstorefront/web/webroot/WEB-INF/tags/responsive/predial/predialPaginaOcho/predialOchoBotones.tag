...
<c:if test="${fn:substring(predialFormocho.opcionuso,0,2) == '01' && predialFormocho.indicadorspac == 'X'}">
			...
			<div class="col-md-12 centercol-md-8 text-center">
				...
				<c:if test="${flagSPAC eq true}">
					<button class="btn btn-primary btn-lg btnspac" type="submit" id="btnspac"
                        name="pagar" value="pagar" data-numbp="${predialFormocho.numBP}" data-numForm="${predialFormocho.numFrom}" data-anio="${predialFormocho.anioGravable}" data-obj="${predialFormocho.objetocontrato}" data-reimpresion="">
