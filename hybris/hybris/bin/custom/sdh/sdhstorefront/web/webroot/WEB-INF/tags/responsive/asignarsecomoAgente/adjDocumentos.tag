				...
				<button class="btn btn-link miritmenu" data-toggle="collapse"
					...
					<h4>
						<span tabindex="0"><spring:theme
								code="autorizado.asignarse.documentos.titulo" text="" /></span>
					</h4>
				</button>
			</h5>
		</div>
					...
					<div class="col-md-12"
						...
						<div class="form-group">
							<label class="control-label"><spring:theme
									code="autorizado.asignarse.documentos.nota1" /></label>
						</div>
					</div>
				</div>
				<div class="row" style="margin-top: 10px">
				...
				<div class="row" style="margin-top: 10px">
					<div class="col-md-2">
						<button class="btn btn-primary" type="button" id="">
							<spring:theme code="autorizado.asignarse.documentos.salir" />
						</button>
					</div>
