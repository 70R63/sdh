				...
				<div class="col-md-2">
					<div class="form-group">
						<label class="control-label"><spring:theme
							...
							id="anoGravable" name="anoGravable" class="newalto form-control"
				...
				<div class="col-md-2">
					<div class="form-group">
						<label class="control-label"><spring:theme
							...
							id="periodo" name="periodo" class="newalto form-control" disabled
							type="text"
							value="${icaInfObjetoFormResp.icaInfObjetoResponse.periodo }"
							maxlength="240"></input>
					</div>
				</div>
				...
				<div class="col-md-2">
					<div class="form-group">
						<label class="control-label"><spring:theme
							...
							id="opcionUso" name="opcionUso" class="newalto form-control" disabled
							type="text"
							value="${icaInfObjetoFormResp.icaInfObjetoResponse.opcionUso }"
							maxlength="240"></input>
					</div>
				</div>
			</div>
