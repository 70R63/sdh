			...
			<div class="col-md-6">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						class="alto form-control" disabled type="text" value="${predialFormtres.desDestino}"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-2">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						name="basegrav" class="newalto form-control" disabled type="text" value="${predialFormtres.estrLiquidacionPredial.baseGravable}"
						maxlength="240"></input>
				</div>
			</div>
		</div>
