...
<div class="container">
	...
	<form:form action="">
			...
			<div class="col-md-5">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						id="totalingPeriodo" name="totalIngrPeriodo"
						class="etiqlargas form-control text-right !important" disabled
						type="text" value="${infoDeclara.totalIngrPeriodo }"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-5">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						disabled id="totalingFueraBog" name="totalingFueraBog"
						class="etiqlargas form-control text-right !important" disabled
						type="text" value="${infoDeclara.totalingFueraBog }"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-5">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						id="totalingBrutos" name="totalingBrutos"
						class="etiqlargas form-control text-right !important" disabled
						type="text" value="${infoDeclara.totalingBrutos }" maxlength="240"></input>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-5">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						id="devolDescuentos" name="devolDescuentos"
						class="etiqlargas form-control text-right !important" disabled
						type="text" value="${infoDeclara.devolDescuentos }"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-5">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						id="impIndusComer" name="impIndusComer"
						class="etiqlargas form-control text-right !important" disabled
						type="text" value="${infoDeclara.impIndusComer }" maxlength="240"></input>
				</div>
			</div>
		</div>
		...
		<c:choose>
			<c:when
				test="${empty infoDeclara.valorImpAviso or fn:trim(infoDeclara.valorImpAviso) le '0.00'}">
				<c:set var="impavtableros_checkedSI" value="" />
				<c:set var="impavtableros_checkedNO" value="checked" />
			</c:when>
			<c:when
				test="${not empty infoDeclara.valorImpAviso and fn:trim(infoDeclara.valorImpAviso) gt '0.00'  }">
			...
			<div class="col-md-5">
				<div class="form-check">
					<label class="form-check-label"
						...
						onclick="habilitar()" value="si" ${impavtableros_checkedSI}>
						Si
			...
			<div class="col-md-5">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						id="totalUnidadAdic" name="totalUnidadAdic"
						class="etiqlargas form-control text-right !important" disabled
						type="text" value="${infoDeclara.totalUnidadAdic }"
						maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-5">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						id="sanciones" name="sanciones"
						class="etiqlargas form-control text-right !important" disabled
						type="text" value="${infoDeclara.sanciones }" maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-5">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						id="saldoCargo" name="saldoCargo"
						class="etiqlargas form-control text-right !important" disabled
						type="text" value="${infoDeclara.saldoCargo }" maxlength="240"></input>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-5">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						id="interesMora" name="interesMora"
						class="etiqlargas form-control text-right !important" disabled
						type="text" value="${infoDeclara.interesMora }" maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-5">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						id="totalPagar" name="totalPagar"
						class="etiqlargas form-control text-right !important" disabled
						type="text" value="${infoDeclara.totalPagar }" maxlength="240"></input>
				</div>
			</div>
		</div>
			...
			<div class="col-md-5">
				<div class="form-group">
					<label class="control-label"><spring:theme
						...
						id="totalAporteVolun" name="totalAporteVolun"
						class="etiqlargas form-control text-right !important" disabled
						type="text" value="${infoDeclara.totalAporteVolun }"
						maxlength="240"></input>
				</div>
			</div>
		</div>
