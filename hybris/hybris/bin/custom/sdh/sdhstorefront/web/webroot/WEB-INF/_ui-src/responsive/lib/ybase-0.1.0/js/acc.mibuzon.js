				...
				var pdf = 'data:application/newpdf;base64,'+ newpdf;
				 var dlnk = document.getElementById('dwnldLnk');
				  ...
				  var newtr = $(this).closest('tr');
					 ...
					 $('#tabPaginacion1').append('<tr><td>' + identif + '</td><td>' + autoridadEmisora + '</td><td>' + asunto + '</td><td>' + fecnot + '</td><td>' + "prueba" + '</td><td><img src="${themeResourcePath}/images/papeleraleidos.png" style="width: 20px"></img></td></tr>');
