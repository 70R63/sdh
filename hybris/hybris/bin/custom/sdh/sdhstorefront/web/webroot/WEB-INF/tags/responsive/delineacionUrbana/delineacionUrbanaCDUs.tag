...
<!-- 								</tr> -->
				...
				<tr>
									<td id="CDU" style="width: 81px !important; padding-left: 1px !important; padding-right: 1px !important;"> ${delineacion.cdu}</td>
									<td  class="inputtextnew">${delineacion.licenConst}
										</td>
									<td>${delineacion.fechaExp}
										</td>
									<td>${delineacion.fechaEjecutoria}
										</td>
									<td class="inputtextnew">${delineacion.nroResolucReva}
										</td>
									<td class="inputtextnew">${delineacion.fechaReval}
										</td>
									<td class="inputtextnew">${delineacion.totalPresup}
									</td>
									<td class="inputtextnew">${delineacion.valorEjecut}
										</td>
									<td class="inputtextnew">${delineacion.tipoMarca}
										</td>
									<td class="inputtextnew">${delineacion.fechFinObra}
										</td>
