...
<p>CLÁUSULA SEGUNDA. USO DEL BUZÓN ELETRÓNICO: El buzón electrónico  tendrá  los siguientes usos:</p>
...
<p><b>CLÁUSULA CUARTA. - DEL TEXTO DEL MENSAJE DE DATOS:</b>Se enviará un mensaje al correo electrónico y/o celular registrado por el contribuyente en la oficina virtual en la que indica que se ha dispuesto un enlace en su correo electrónico o celular desde el cual puede acceder  a  la  oficina  virtual  a  revisar  sus  mensajes  en  el  buzón"  El  texto  del  mensaje mediante el cual se le comunica que tiene notificación en su buzón electrónico debe indicara que  se  ha  dispuesto  un  enlace  en  su  correo  electrónico  o  celular  desde el  cual  puede  acceder a la oficina virtual a revisar sus mensajes en el buzón, se adjuntará un certificado de  la  notificación  que  contendrá  Nombre  el  del  interesado  y  la  fecha  de  expedición  del  mensaje de datos del acto y oficina que lo genera.</p>
...
<p>Autorizado el buzón, este quedará habilitado por un año y solo pasado este tiempo podrá cambiar el estado de autorización.</p>
						...
						<div class="row">
							...
							<button class="btn btn-primary btn-block btn-lg " type="button"
								id="cboxClose" onclick= "ACC.mirit.terminosAceptarRegister()">
							...
							<button class="btn btn-secondary btn-block btn-lg " type="button"
								id="cboxClose" onclick= "ACC.mirit.terminosCancelarRegister()">
