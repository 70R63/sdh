...
<%@ taglib prefix="product"
	tagdir="/WEB-INF/tags/addons/publicsectoracceleratoraddon/responsive/product"%>

<template:page pageTitle="${pageTitle}">
	<cms:pageSlot position="Section1" var="comp" element="div"
		class="productDetailsPageSection1">
	...
	<cms:pageSlot position="Section3" var="comp" element="div"
		class="productDetailsPageSection3">
		<cms:component component="${comp}" />
	</cms:pageSlot>
	...
	<cms:pageSlot position="Section4" var="comp" element="div"
		class="productDetailsPageSection4">
		<cms:component component="${comp}" />
	</cms:pageSlot>
</template:page>