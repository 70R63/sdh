ACC.delineacionurbana = {
	 ...
	 _autoload: ["bindretenciondelibutton","binddeclaradelibutton", "bindCalculoButton","bindSearchButton","bindPresentarDeclaracionButton","bindDialogPublicidadExterior","bindDataTable"],
	 
	
	 
	 bindGeneradeclaradelibutton: function () {
		 $(document).on("click", "#declaradelibutton", function (e) {
	 	      ...
	 	      $.ajax({
		            url: "/contribuyentes/delineacionurbana/declaracion",
		            data: data,
		            type: "GET",
