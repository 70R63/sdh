				...
				<button class="btn btn-link miritmenu" data-toggle="collapse"
					...
					<h4>
						<span tabindex="0"><spring:theme
								code="autorizado.crear.impuesto.titulo" text="" /></span>
					</h4>
				</button>
			</h5>
		</div>
					...
					<div class="col-md-12"
						...
						<div class="form-group">
							<label class="control-label"><spring:theme
									code="autorizado.crear.impuesto.nota1" /></label>
						</div>
					</div>
				</div>
				<div class="row">
						...
						<div class="fomchk form-group ">
							<div class="chkagent checkbox" role="checkbox"
								...
								<label tabindex="0" class="chkagent control-label  "> <input
									id="" name="" type="checkbox" value="true"> <input
									type="hidden" name="_consentForm.consentGiven" value="on">
									<spring:theme code="autorizado.crear.impuesto.conciga" />
								</label>
							</div>
						</div>
					</div>
						...
						<div class="fomchk form-group ">
							<div class="chkagent checkbox" role="checkbox"
								...
								<label tabindex="0" class="chkagent control-label  "> <input
									id="" name="" type="checkbox" value="true"> <input
									type="hidden" name="_consentForm.consentGiven" value="on">
									<spring:theme code="autorizado.crear.impuesto.estuni" />
								</label>
							</div>
						</div>
					</div>
						...
						<div class="fomchk form-group ">
							<div class="chkagent checkbox" role="checkbox"
								...
								<label tabindex="0" class="chkagent control-label  "> <input
									id="" name="" type="checkbox" value="true"> <input
									type="hidden" name="_consentForm.consentGiven" value="on">
									<spring:theme code="autorizado.crear.impuesto.undist" />
								</label>
							</div>
						</div>
					</div>
						...
						<div class="fomchk form-group ">
							<div class="chkagent checkbox" role="checkbox"
								...
								<label tabindex="0" class="chkagent control-label  "> <input
									id="" name="" type="checkbox" value="true"> <input
									type="hidden" name="_consentForm.consentGiven" value="on">
									<spring:theme code="autorizado.crear.impuesto.contespecial" />
								</label>
							</div>
						</div>
					</div>
						...
						<div class="fomchk form-group ">
							<div class="chkagent checkbox" role="checkbox"
								...
								<label tabindex="0" class="chkagent control-label  "> <input
									id="" name="" type="checkbox" value="true"> <input
									type="hidden" name="_consentForm.consentGiven" value="on">
									<spring:theme code="autorizado.crear.impuesto.soblot" />
								</label>
							</div>
						</div>
					</div>
						...
						<div class="fomchk form-group ">
							<div class="chkagent checkbox" role="checkbox"
								...
								<label tabindex="0" class="chkagent control-label  "> <input
									id="" name="" type="checkbox" value="true"> <input
									type="hidden" name="_consentForm.consentGiven" value="on">
									<spring:theme code="autorizado.crear.impuesto.delurban" />
								</label>
							</div>
						</div>
					</div>
						...
						<div class="fomchk form-group ">
							<div class="chkagent checkbox" role="checkbox"
								...
								<label tabindex="0" class="chkagent control-label  "> <input
									id="" name="" type="checkbox" value="true"> <input
									type="hidden" name="_consentForm.consentGiven" value="on">
									<spring:theme code="autorizado.crear.impuesto.lorfor" />
								</label>
							</div>
						</div>
					</div>
						...
						<div class="fomchk form-group ">
							<div class="chkagent checkbox" role="checkbox"
								...
								<label tabindex="0" class="chkagent control-label  "> <input
									id="" name="" type="checkbox" value="true"> <input
									type="hidden" name="_consentForm.consentGiven" value="on">
									<spring:theme code="autorizado.crear.impuestovehiculos" />
								</label>
							</div>
						</div>
					</div>
