				...
				<thead>
					<tr class="avisoheadline p">
						<td style="text-align: center"><spring:theme
								code="predialsiete.generales.titulo" /></td>
					</tr>
				</thead>
				<tbody>
					<tr class="avisobody">

						<td><spring:theme code="predialsiete.generales.descripcion1" /><a
							href="http://www.shd.gov.co/shd/" target="_blank"> Mas
								información</a><br> <spring:theme
								code="predialsiete.generales.descripcion2" /></td>
					</tr>
				</tbody>
			</table>
		</div>
			...
			<div class="col-md-6 col-md-offset-4 d-flex align-items-center">
				<div class="table-responsive text-center">
					<table class="table table-bordered">
						...
						<tbody>
							<tr>
								<td><c:out value="${predialFormsiete.tipDoc}" /></td>
								<td><c:out value="${predialFormsiete.numDoc}" /></td>
								<td><c:out value="${predialFormsiete.compleName}" /></td>
							</tr>
						</tbody>
					</table>
				</div>
				...
				<div class="headline">
					<h2>
						<span class="col-md-10 "><spring:theme
								code="predialsiete.generales.titulodatos" /></span>
					</h2>
				</div>
			</div>
		</div>
