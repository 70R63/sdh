...
/**
 * The class of PSRelatedLinksComponentController.
 */
@Controller("PSRelatedLinksComponentController")
@RequestMapping(value = ControllerConstants.Actions.Cms.PSRelatedLinksComponent)
public class PSRelatedLinksComponentController<C extends PSRelatedLinksComponentModel>
		extends SubstitutingCMSAddOnComponentController<C>
{
	...
	/**
	 * Fills the model with required attributes for displaying service relatedLinks content
	 *
	 * @param request
	 * @param model
	 * @param component
	 */
	@Override
	protected void fillModel(final HttpServletRequest request, final Model model, final PSRelatedLinksComponentModel component)
	{
		...
		if (currentProduct != null && (currentProduct instanceof PSServiceProductModel))
		{
			...
			final PSRelatedLinksData relatedLinksData = productData.getRelatedLinks();
			model.addAttribute("relatedLinks", relatedLinksData);
		}
	}
}
