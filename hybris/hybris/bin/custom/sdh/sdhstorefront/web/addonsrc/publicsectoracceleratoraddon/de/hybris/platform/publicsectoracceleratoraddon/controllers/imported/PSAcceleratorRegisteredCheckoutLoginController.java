 ...
 *
 */
package de.hybris.platform.publicsectoracceleratoraddon.controllers.imported;
...
/**
 * Registered Checkout Login Controller. Handles login and register for the registered services checkout flow.
 */
@Scope("tenant")
@RequestMapping(value = "/login/registeredcheckout")
public class PSAcceleratorRegisteredCheckoutLoginController extends AbstractLoginPageController
{
	...
	{
		return getContentPageForLabelOrId("register-checkout-login");
	}
	...
	{
		model.addAttribute("showRegisterBody", Boolean.TRUE);
		model.addAttribute("registeredCheckout", Boolean.TRUE);
	...
	{
		return ControllerConstants.Views.Pages.Checkout.RegisteredCheckoutLoginPage;
	}
