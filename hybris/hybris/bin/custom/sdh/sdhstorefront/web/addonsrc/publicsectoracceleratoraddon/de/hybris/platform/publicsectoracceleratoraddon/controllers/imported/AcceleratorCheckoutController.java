...
{
	private static final Logger LOG = LoggerFactory.getLogger(AcceleratorCheckoutController.class);
	/**
	...
	{
		LOG.error("Requested model not found {}", exception);
			...
			throws CMSItemNotFoundException
	{
		...
		populateOrderEntriesWithProduct(orderDetails);
	 ...
	 * @param orderDetails
	 */
	private void populateOrderEntriesWithProduct(final OrderData orderDetails)
	{
