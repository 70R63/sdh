...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sdhstorefront/electronics/en",
						"https://electronics.local:9002/sdhstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sdhstorefront/electronics/en",
						"https://electronics.local:9002/sdhstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sdhstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/sdhstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sdhstorefront/electronics/en",
						"https://electronics.local:9002/sdhstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sdhstorefront",
						"https://electronics.local:9002/sdhstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sdhstorefront",
						"https://electronics.local:9002/sdhstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/sdhstorefront/electronics/en",
						"https://electronics.local:9002/sdhstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
