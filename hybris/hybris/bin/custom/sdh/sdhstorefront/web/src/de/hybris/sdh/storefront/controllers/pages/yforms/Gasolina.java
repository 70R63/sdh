...
public class Gasolina extends AbstractSearchPageController
{
	...
	// CMS Pages
	private static final String GASOLINA_LIQUIDADOR_CMS_PAGE = "cms-page-gasolina-liquidador";
	...
	public String updateExampleForm(final Model model) throws CMSItemNotFoundException
	{
		...
		storeCmsPageInModel(model, getContentPageForLabelOrId(GASOLINA_LIQUIDADOR_CMS_PAGE));
		setUpMetaDataForContentPage(model, getContentPageForLabelOrId(GASOLINA_LIQUIDADOR_CMS_PAGE));
