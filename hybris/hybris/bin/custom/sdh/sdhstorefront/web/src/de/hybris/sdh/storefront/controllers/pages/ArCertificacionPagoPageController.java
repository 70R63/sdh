...
public class ArCertificacionPagoPageController extends AbstractPageController
{
		...
		if (certiFormPost.getIdimp().equals("5"))
		{
			...
			try
			{
				...
				consultaPagoResp = consultaPagoResp.replaceAll("(\"declaraciones\"):\\{((\"\\w*\":(\"\\w*\"|\\w*),*\\s*)*\\s*)\\}",
						"$1:\\[\\{$2\\}\\]");
				final ConsultaPagoResponse consultaPagoResponse = mapper.readValue(consultaPagoResp, ConsultaPagoResponse.class);
	...
	@RequestMapping(value = "/setComplete10", method = RequestMethod.POST)
