...
public class ARListaDeclaracionesPageController extends AbstractPageController
{
	...
	public String listadeclaraciones(final Model model, final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		...
		/*
		 * System.out.println("---------------- INI Seleccion Proxy --------------------------"); final String pconfig =
		 * configurationService.getConfiguration().getString("sdh.pse.http.configuracion"); final String phttpProxyHostACH
		 * = configurationService.getConfiguration().getString("sdh.pse.http.proxyHostACH"); final String
		 * phttpProxyPortACH = configurationService.getConfiguration().getString("sdh.pse.http.proxyPortACH"); final
		 * String phttpProxyHostInternet =
		 * configurationService.getConfiguration().getString("sdh.pse.http.proxyHostInternet"); final String
		 * phttpProxyPortInternet = configurationService.getConfiguration().getString("sdh.pse.http.proxyPortInternet");
