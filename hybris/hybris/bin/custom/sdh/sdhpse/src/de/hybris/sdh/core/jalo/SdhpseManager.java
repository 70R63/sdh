...
/**
 * This is the extension manager of the Sdhpse extension.
 */
public class SdhpseManager extends GeneratedSdhpseManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SdhpseManager.class);
	 ...
	 */
	public static SdhpseManager getInstance()
	{
		return (SdhpseManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SdhpseConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SdhpseManager() // NOPMD 
	{
		LOG.debug("constructor of SdhpseManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SdhpseManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SdhpseManager called, current tenant: {}", getTenant().getTenantID());
	}
