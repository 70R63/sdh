...
public class DefaultSdhpseService implements SdhpseService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSdhpseService.class);
	...
	{
		return DefaultSdhpseService.class.getResourceAsStream("/sdhpse/sap-hybris-platform.png");
	}
