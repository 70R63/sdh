...
public class OnlinePaymentMatcherFullBankPopulator implements Populator<OlnPymntPvdMatcherModel, OnlinePaymentSelectInputBoxData> {
    ...
    public void populate(OlnPymntPvdMatcherModel olnPymntPvdMatcherModel, OnlinePaymentSelectInputBoxData onlinePaymentSelectInputBoxData) throws ConversionException {
        onlinePaymentSelectInputBoxData.setCode(olnPymntPvdMatcherModel.getBank().getFinancialInstitutionCode());
        onlinePaymentSelectInputBoxData.setDescription(olnPymntPvdMatcherModel.getBank().getFinancialInstitutionName());
    }
}
