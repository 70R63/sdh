...
public class ZWS_HYSEND_MAIL_ServiceLocator extends org.apache.axis.client.Service implements mc_style.functions.soap.sap.document.sap_com.ZWS_HYSEND_MAIL_Service {
    ...
    public mc_style.functions.soap.sap.document.sap_com.ZWS_HYSEND_MAIL_PortType getZWS_HYSEND_MAIL() throws javax.xml.rpc.ServiceException {
    ...
    public mc_style.functions.soap.sap.document.sap_com.ZWS_HYSEND_MAIL_PortType getZWS_HYSEND_MAIL(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mc_style.functions.soap.sap.document.sap_com.ZWS_HYSEND_MAIL_BindingStub _stub = new mc_style.functions.soap.sap.document.sap_com.ZWS_HYSEND_MAIL_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mc_style.functions.soap.sap.document.sap_com.ZWS_HYSEND_MAIL_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mc_style.functions.soap.sap.document.sap_com.ZWS_HYSEND_MAIL_BindingStub _stub = new mc_style.functions.soap.sap.document.sap_com.ZWS_HYSEND_MAIL_BindingStub(new java.net.URL(ZWS_HYSEND_MAIL_address), this);
                _stub.setPortName(getZWS_HYSEND_MAILWSDDServiceName());
                return _stub;
            }
        }
