/**
 * ZWS_HYSEND_MAIL_BindingStub.java
 *
...
public class ZWS_HYSEND_MAIL_BindingStub extends org.apache.axis.client.Stub implements mc_style.functions.soap.sap.document.sap_com.ZWS_HYSEND_MAIL_PortType {
    ...
    public ZWS_HYSEND_MAIL_BindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ZWS_HYSEND_MAIL_BindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ZWS_HYSEND_MAIL_BindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public void zcrmfHysendMail(java.lang.String piEmail, java.lang.String piMessage, java.lang.String piSubject, javax.xml.rpc.holders.StringHolder epCode, javax.xml.rpc.holders.StringHolder epMessage) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("urn:sap-com:document:sap:soap:functions:mc-style:ZWS_HYSEND_MAIL:ZcrmfHysendMailRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("urn:sap-com:document:sap:soap:functions:mc-style", "ZcrmfHysendMail"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {piEmail, piMessage, piSubject});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                epCode.value = (java.lang.String) _output.get(new javax.xml.namespace.QName("", "EpCode"));
            } catch (java.lang.Exception _exception) {
                epCode.value = (java.lang.String) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("", "EpCode")), java.lang.String.class);
            }
            try {
                epMessage.value = (java.lang.String) _output.get(new javax.xml.namespace.QName("", "EpMessage"));
            } catch (java.lang.Exception _exception) {
                epMessage.value = (java.lang.String) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("", "EpMessage")), java.lang.String.class);
            }
        }
