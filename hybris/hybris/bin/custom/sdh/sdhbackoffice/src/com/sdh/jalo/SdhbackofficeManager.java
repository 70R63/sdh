...
import com.sdh.constants.SdhbackofficeConstants;
 ...
 */
public class SdhbackofficeManager extends GeneratedSdhbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SdhbackofficeManager.class.getName());
	 ...
	 */
	public static SdhbackofficeManager getInstance()
	{
		return (SdhbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SdhbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SdhbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SdhbackofficeManager called.");
		}
	}
