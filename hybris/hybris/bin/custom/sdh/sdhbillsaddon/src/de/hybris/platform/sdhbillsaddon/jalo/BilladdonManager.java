 ...
 *  
 */
package de.hybris.platform.sdhbillsaddon.jalo;
...
import de.hybris.platform.sdhbillsaddon.constants.BilladdonConstants;



/**
 * This is the extension manager of the Billaddon extension.
 */
public class BilladdonManager extends GeneratedBilladdonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(BilladdonManager.class.getName());
	 ...
	 */
	public static BilladdonManager getInstance()
	{
		return (BilladdonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(BilladdonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BilladdonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of BilladdonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of BilladdonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of BilladdonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
