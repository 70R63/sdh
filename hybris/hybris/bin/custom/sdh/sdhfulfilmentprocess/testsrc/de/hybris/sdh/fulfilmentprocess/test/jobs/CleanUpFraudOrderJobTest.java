 ...
 */
package de.hybris.sdh.fulfilmentprocess.test.jobs;
...
import de.hybris.sdh.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = SdhFulfilmentProcessConstants.ORDER_PROCESS_NAME;
