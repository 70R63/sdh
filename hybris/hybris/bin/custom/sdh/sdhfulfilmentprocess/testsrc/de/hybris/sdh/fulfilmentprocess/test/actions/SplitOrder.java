 ...
 */
package de.hybris.sdh.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(SdhFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SdhFulfilmentProcessConstants.PARENT_PROCESS);
